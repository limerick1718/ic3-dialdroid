      ...
      if (arguments != null) {
        ...
        if (valueMap.containsKey("activity")) {
          DbConnection.insertIntentAtExitPoint(className, methodSignature, unitId,
              ...
              entryPointMap.get(method), componentToIdMap, unit);
          ...
          String targetType = basePropagationValue instanceof PropagationValue
              ? (String) ((PropagationValue) basePropagationValue).getValuesForField("targetType")
